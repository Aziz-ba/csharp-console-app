...
The whole thing runs in a `do/while` loop so you can try several exercises in one session.
...
Requires the [.NET SDK](https://dotnet.microsoft.com/download) (8.0+). The project file targets `net8.0`.
...
C# · .NET · console I/O · arrays · regular expressions
